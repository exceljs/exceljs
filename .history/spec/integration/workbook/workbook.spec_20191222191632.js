  ...
  describe('Serialise', () => {
    ...
    describe('Merge Cells', () => {
      ...
      it('styles', () => {
        ...
        ws.fillCells('C3:D4', testUtils.styles.redGreenDarkTrellis);
        return wb.xlsx
          .writeFile(TEST_XLSX_FILE_NAME)
          .then(() => {
            const wb2 = new ExcelJS.Workbook();
          ...
          .then(wb2 => {
            ...
            expect(ws2.getCell('C4').fill).to.deep.equal(
              testUtils.styles.fills.redGreenDarkTrellis
            );
            expect(ws2.getCell('D3').fill).to.deep.equal(
              testUtils.styles.fills.redGreenDarkTrellis
            );
            expect(ws2.getCell('D4').fill).to.deep.equal(
              testUtils.styles.fills.redGreenDarkTrellis
            );
