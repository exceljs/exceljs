...
<ul>
    <li>
      Merged <a href="https://github.com/guyonroche/exceljs/pull/201">Fix issue #178 #201</a>
      Adds the following properties to workbook:
        <ul>
            <li>title</li>
            <li>subject</li>
            <li>keywords</li>
      ...
      Thanks to <a href="https://github.com/stavenko">stavenko</a> for the contribution.
    </li>
</ul>
