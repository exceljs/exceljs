...
const its = {
  prepare(expectation) {
    it('Prepare Model', () => new Promise(resolve => {
  ...
  render(expectation) {
    it('Render to XML', () => new Promise(resolve => {
  ...
  'prepare-render': function(expectation) {
    ...
    it('Prepare and Render to XML', () => new Promise(resolve => {
      const model = getExpectation(expectation, 'initialModel');
      const result = getExpectation(expectation, 'xml');
  ...
  renderIn(expectation) {
    it('Render in Composite to XML ', () => new Promise(resolve => {
      const model = {
        pre: true,
  ...
  parseIn(expectation) {
    it('Parse within composite', () => new Promise((resolve, reject) => {
  ...
  parse(expectation) {
    it('Parse to Model', () => new Promise((resolve, reject) => {
  ...
  reconcile(expectation) {
    it('Reconcile Model', () => new Promise(resolve => {
