...
const expectations = [
  {
    title: 'Expression',
    create() { return new CfRuleXform(); },
    preparedModel: {type: 'expression', dxfId: 1, priority: 1, formulae: ['ROW()']},
    xml: `
      <cfRule type="expression" dxfId="1" priority="1">
        <formula>ROW()</formula>
      </cfRule>
    `,
    parsedModel: {type: 'expression', dxfId: 1, priority: 1, formulae: ['ROW()']},
    tests: ['render', 'parse'],
  },
  {
    title: 'Cell Is',
    create() { return new CfRuleXform(); },
    preparedModel: {type: 'cellIs', dxfId: 1, priority: 1, operator: 'greaterThan', formulae: ['1']},
    xml: `
      <cfRule type="cellIs" dxfId="1" priority="1" operator="greaterThan">
        <formula>1</formula>
      </cfRule>
    `,
    parsedModel: {type: 'cellIs', dxfId: 1, priority: 1, operator: 'greaterThan', formulae: ['1']},
    tests: ['render', 'parse'],
  },
  {
    title: 'Top 10',
  ...
  },
  {
    title: 'Top 10%',
    create() { return new CfRuleXform(); },
    preparedModel: {type: 'top10', dxfId: 1, priority: 1, rank: 10, percent: true},
    xml: '<cfRule type="top10" dxfId="1" priority="1" rank="10" percent="1" />',
    parsedModel: {type: 'top10', dxfId: 1, priority: 1, rank: 10, percent: true},
    tests: ['render', 'parse'],
  },
  {
    title: 'Bottom 10',
    create() { return new CfRuleXform(); },
    preparedModel: {type: 'top10', dxfId: 1, priority: 1, rank: 10, bottom: true},
  ...
  },
  {
    title: 'Below Average',
    create() { return new CfRuleXform(); },
    preparedModel: {type: 'aboveAverage', dxfId: 1, priority: 1, aboveAverage: false},
    xml: '<cfRule type="aboveAverage" dxfId="1" priority="1" aboveAverage="0" />',
    parsedModel: {type: 'aboveAverage', dxfId: 1, priority: 1, aboveAverage: false},
    tests: ['render', 'parse'],
  },
  {
    title: 'Colour Scale',
