        ...
        if (eventType === 'opentag') {
              ...
              case 'col':
                if (inCols) {
                  cols.push({
                    ...
                    hidden: utils.parseBoolean(node.attributes.hidden),
                  });
                }
                break;
              ...
              case 'row':
                if (inRows) {
                  ...
                  if (node.attributes.hidden) {
                    row.hidden = utils.parseBoolean(node.attributes.hidden);
                  }
                }
                break;
              case 'c':
          ...
          if (emitSheet) {
            switch (node.name) {
              case 'cols':
                inCols = false;
                this._columns = Column.fromModel(this.workbook.worksheet, cols);
                break;
              case 'sheetData':
                inRows = false;
                break;
