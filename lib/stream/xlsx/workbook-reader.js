...
class WorkbookReader extends EventEmitter {
  constructor(input, options) {
    ...
    this.options.worksheets = this.options.worksheets || 'emit';
    this.options.sharedStrings = this.options.sharedStrings || 'cache';
    this.options.hyperlinks = this.options.hyperlinks || 'ignore';
    this.options.styles = this.options.styles || 'ignore';
    this.options.entries = this.options.entries || 'ignore';
