...
class XLSX {
  ...
  async _processDrawingEntry(entry, model, name) {
    ...
    // DrawingXform returns null when the part isn't a spreadsheet drawing
    // (e.g. a <c:userShapes> chart drawing the filename glob also matches).
    // We skip storing those so downstream code can assume entries in
    // model.drawings are real spreadsheet drawings.
    if (drawing) {
