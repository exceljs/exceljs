...
utils.inherits(RowXform, BaseXform, {
  ...
  parseOpen: function(node) {
    if (this.parser) {
      ...
      this.numRowsSeen += 1;
      if (typeof this.options.maxRows === 'number' && this.numRowsSeen === this.options.maxRows) {
        ...
        //
        // Avoid spending memory on those rows by enforcing a limit of how
        // many rows we're willing to parse. For one file in particular,
