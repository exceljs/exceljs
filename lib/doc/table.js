...
class Table {
  ...
  validate() {
    ...
    // Table must have a valid name, i.e. no spaces or special characters, no initial numbers
    assert(
      isValidExcelTableName(table.name),
      'Invalid Table name. See Microsoft documentation for requirements for table names.'
    );

    function isValidExcelTableName(name) {
      // Regular expression for valid Excel table names
