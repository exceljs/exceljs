...
const DefinedNames = (module.exports = function() {
  this.matrixMap = {};
});
...
DefinedNames.prototype = {
  ...
  get model() {
    ...
    return _.map(this.matrixMap, (matrix, name) => self.getRanges(name, matrix)).filter(definedName => definedName.ranges.length);
  },
  set model(value) {
