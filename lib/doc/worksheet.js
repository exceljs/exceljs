...
class Worksheet {
  ...
  protect(password, options){
    ...
    if(this.sheetProtection.selectLockedCells === false && this.sheetProtection.selectUnlockedCells){
      this.sheetProtection.objects = true;
      this.sheetProtection.scenarios = true;
    }
  }
