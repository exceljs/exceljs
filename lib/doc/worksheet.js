...
class Worksheet {
  constructor(options) {
    ...
    // allow name truncated
    this.allowNameTruncated = options.allowNameTruncated === undefined ? true : options.allowNameTruncated;
  ...
  set name(name) {
    ...
    if (this.allowNameTruncated && name && name.length > 31) {
