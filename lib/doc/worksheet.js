  ...
  insertRows(pos, values, styleOption = 'n') {
    ...
    if (styleOption !== 'n') {
      ...
      for (let i = 0; i < values.length; i++) {
        if (styleOption === 'o' && this.findRow(values.length + pos + i) !== undefined) this._copyStyle(values.length + pos + i, pos + i);
        else if (styleOption === 'i' && this.findRow(pos - 1) !== undefined) this._copyStyle(pos - 1, pos + i);
      }
    }
  }
