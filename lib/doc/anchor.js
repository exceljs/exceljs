...
class Anchor {
  ...
  get colWidth() {
    let width = this.worksheet && this.worksheet.properties && this.worksheet.properties.defaultColWidth ? this.worksheet.properties.defaultColWidth : 9.14285714285714;
  ...
  get rowHeight() {
    let height = this.worksheet && this.worksheet.properties && this.worksheet.properties.defaultRowHeight ? this.worksheet.properties.defaultRowHeight : 15;
    return this.worksheet &&
